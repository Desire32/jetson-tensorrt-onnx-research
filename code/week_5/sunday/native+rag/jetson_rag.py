"""
The code was initially taken from [https://www.jetson-ai-lab.com/tutorial_jetson-copilot.html]
"""
...
if 'granite4:latest' not in models:
    with st.spinner('Downloaing granite model ...'):
        ollama.pull('granite4:350m')
        logging.info(" ### Downloaing granite completed.")
